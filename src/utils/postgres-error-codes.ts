export const PgSuccessfulCompletion = {
  SuccessfulCompletion: '00000',
}

export const PgWarning = {
  Warning: '01000',
...
export const PgNoData = {
  NoData: '02000',
  NoAdditionalDynamicResultSetsReturned: '02001',
}

export const PgSqlStatementNotYetComplete = {
  SqlStatementNotYetComplete: '03000',
}

export const PgConnectionException = {
...
export const PgTriggeredActionException = {
  TriggeredActionException: '09000',
}

export const PgFeatureNotSupported = {
  FeatureNotSupported: '0A000',
}

export const PgInvalidTransactionInitiation = {
  InvalidTransactionInitiation: '0B000',
}

export const PgLocatorException = {
  LocatorException: '0F000',
  InvalidLocatorSpecification: '0F001',
}

export const PgInvalidGrantor = {
  InvalidGrantor: '0L000',
  InvalidGrantOperation: '0LP01',
}

export const PgInvalidRoleSpecification = {
  InvalidRoleSpecification: '0P000',
}

export const PgDiagnosticsException = {
  DiagnosticsException: '0Z000',
  StackedDiagnosticsAccessedWithoutActiveHandler: '0Z002',
}

export const PgCaseNotFound = {
  CaseNotFound: '20000',
}

export const PgCardinalityViolation = {
  CardinalityViolation: '21000',
}

export const PgDataException = {
  DataException: '22000',
...
export const PgIntegrityConstraintViolation = {
...
export const PgInvalidCursorState = {
  InvalidCursorState: '24000',
}

export const PgInvalidTransactionState = {
...
export const PgInvalidSqlStatementName = {
  InvalidSqlStatementName: '26000',
}

export const PgTriggeredDataChangeViolation = {
  TriggeredDataChangeViolation: '27000',
}

export const PgInvalidAuthorizationSpecification = {
  InvalidAuthorizationSpecification: '28000',
  InvalidPassword: '28P01',
}

export const PgDependentPrivilegeDescriptorsStillExist = {
  DependentPrivilegeDescriptorsStillExist: '2B000',
  DependentObjectsStillExist: '2BP01',
}

export const PgInvalidTransactionTermination = {
  InvalidTransactionTermination: '2D000',
}

export const PgSqlRoutineException = {
...
export const PgInvalidCursorName = {
  InvalidCursorName: '34000',
}

export const PgExternalRoutineException = {
...
export const PgExternalRoutineInvocationException = {
...
export const PgSavepointException = {
  SavepointException: '3B000',
  InvalidSavepointSpecification: '3B001',
}

export const PgInvalidCatalogName = {
  InvalidCatalogName: '3D000',
}

export const PgInvalidSchemaName = {
  InvalidSchemaName: '3F000',
}

export const PgTransactionRollback = {
...
export const PgSyntaxErrorOrAccessRuleViolation = {
...
export const PgWithCheckOptionViolation = {
  WithCheckOptionViolation: '44000',
}

export const PgInsufficientResources = {
...
export const PgProgramLimitExceeded = {
...
export const PgObjectNotInPrerequisiteState = {
...
export const PgOperatorIntervention = {
...
export const PgSnapshotFailure = {
  SnapshotTooOld: '72000',
}

export const PgConfigurationFileError = {
  ConfigFileError: 'F0000',
  LockFileExists: 'F0001',
}

export const PgForeignDataWrapperError = {
  FdwError: 'HV000',
